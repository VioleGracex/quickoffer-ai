export default function EmailDetails() {
    return (
      <div className="h-screen overflow-y-auto">
        <div className="custom-scrollbar block h-full max-h-full overflow-auto p-5 xl:p-6">
          ...
          <div className="rounded-xl bg-gray-50 p-3 dark:bg-gray-900 sm:p-4">
            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              <div className="relative flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pl-3 pr-5 dark:border-gray-800 dark:bg-white/5 sm:w-auto">
